  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-green-400 to-teal-500 shadow-lg">
        <div className="container mx-auto flex justify-between items-center py-4 px-4 md:px-8 mr-3 ">
          <div className="flex items-center justify-between w-full">
            ...
            <div className="md:hidden flex items-center" onClick={toggleMobileMenu}>
              ...
              <span className="text-white font-semibold ml-2">WTE- Conference</span>
            </div>
            ...
            <div className="hidden md:flex space-x-20">
              {['/', '/About', '/Registration', '/How to Reach', '/Speakers', '/Schedule', '/Contact'].map((path, index) => (
                <a
                  key={index}
                  href={path}
                  className="relative text-white font-semibold text-2xl tracking-wider hover:text-white hover:underline transition-all duration-500 ease-in-out transform hover:scale-110"
                >
          ...
          <div className="flex flex-col items-center">
            {['/', '/About', '/Registration', '/How to Reach', '/Speakers', '/Schedule', '/Contact'].map((path, index) => (
              <a
                key={index}
                href={path}
                className="text-white font-semibold text-xl my-2 hover:text-white hover:underline transition-all duration-500 ease-in-out"
